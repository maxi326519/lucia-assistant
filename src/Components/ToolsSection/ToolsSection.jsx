...
export default function ToolsSection() {
  return (
    <div id="tools">
      <div class="tools__container" data-aos="fade-up" data-aos-duration="1000">
        ...
        <div className="content-modulos">
          ...
          >
            ...
            <div>
              ...
              <p>
                Define la cantidad con la que quieres que aparten tu cita 10%
                15% o la cantidad que decidas, con ellos tus clientes tendrán
                que hacer un mínimo pago para reservar su cita.
              </p>
            </div>
          </div>
          {/* $299 mxn mensual */}
          ...
          >
            ...
            <div>
              <h3>Pago online</h3>
              <p>
                Permite a tus clientes pagar directamente desde la página web.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div>
              ...
              <p>
                Agregar servicios, precios y profesionales, tienes el control de
                todo.
              </p>
            </div>
          </div>
